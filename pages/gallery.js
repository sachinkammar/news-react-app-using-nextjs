        ...
        <div className="site-main-container">
            ...
            <div className="container no-padding">
                ...
                <div className="col-lg-12">
                    ...
                    <h1 className="text-white">Gallery Post</h1>
                    <p className="text-white link-nav"><a href="index.html">Home </a>  <span className="lnr lnr-arrow-right" /><a href="#">Post Types </a><span className="lnr lnr-arrow-right" /><a href="gallery-post.html">Gallery Post </a></p>
                    </div>
                </div>
                <div className="col-lg-12">
            ...
            <div className="container no-padding">
                ...
                <div className="col-lg-8 post-list">
                    ...
                    <div className="feature-img-thumb relative">
                        <div className="active-gallery-carusel">
                        <div className="single-img relative">
                            <div className="overlay overlay-bg" />
                            <img className="img-fluid item" src="../static/img/g1.jpg" alt />
                        </div>
                        <div className="single-img relative">
                            <div className="overlay overlay-bg" />
                            <img className="img-fluid item" src="../static/img/g2.jpg" alt />
                        </div>
                        <div className="single-img relative">
                            <div className="overlay overlay-bg" />
                            <img className="img-fluid item" src="../static/img/g3.jpg" alt />
                        </div>
                        </div>
                    </div>
